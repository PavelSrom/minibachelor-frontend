...
export const ProjectCard: React.FC<Props> = memo(
  ({ project, onDetailClick }) => {
    const userInitials =
      project.userName[0].toUpperCase() + project.userSurname[0].toUpperCase()
      ...
      <Card>
        ...
        <CardActions className="flex justify-between">
          <div className="flex items-center">
            ...
            <Text variant="body2">
              by{' '}
              <span className="font-semibold">{`${project.userName} ${project.userSurname}`}</span>
            </Text>
          </div>
